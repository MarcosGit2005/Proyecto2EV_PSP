package com.example.proyecto2ev_psp.config;

import com.example.proyecto2ev_psp.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private final JwtAuthenticationFilter jwtAuthenticationFileter;
